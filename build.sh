...
echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('ken-morek', 'engonken8@gmail.com', '1+2=Three')" | python manage.py shell
