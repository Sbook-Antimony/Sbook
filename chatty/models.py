...
class ChattyRoom(models.Model):
    ...
    admin = models.ForeignKey(
        ChattyUser, related_name="admins", on_delete=models.CASCADE
    )
...
class ChattyTextMessage(models.Model):
    ...
    sender = models.ForeignKey(
        ChattyUser, related_name="sent", on_delete=models.CASCADE
    )
    room = models.ForeignKey(
        ChattyRoom, related_name="messages", on_delete=models.CASCADE
    )
